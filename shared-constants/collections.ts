...
export const PRODUCTS_USER_COLLECTION: string = 'v2_productsUser';
export const OPTIONS_USER_COLLECTION: string = 'v2_optionsUser';
export const CATEGORIES_USER_COLLECTION: string = 'v2_categoriesUser';
